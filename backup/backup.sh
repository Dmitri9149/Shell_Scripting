...
# This bash script is used to backup a user's /home/user/... subdirectories 
## (which are given as script parameters)
# to /tmp/. 
...
function backup {
        ...
        input=/home/$user/$1
        output=/tmp/${user}_$1_home_$(date +%Y-%m-%d_%H%M%S).tar.gz
